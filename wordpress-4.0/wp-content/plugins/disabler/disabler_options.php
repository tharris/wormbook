...
class Disabler_Options_Class
{
	...
	function disabler_settings()
	{
		...
		add_settings_field( 'new_selfping', __( "Disable self pings (i.e. trackbacks/pings from your own domain).", 'ippy_dis' ), array( $this, 'selfping' ), 'disabler_options_page', 'backend_settings', array( 'label_for' => 'new_selfping' ) );
