// Generically setting up meta boxes.
...
// The makeup of our individual boxes
function wbg_meta_boxes($meta_name = false) {
  ...
  $meta_boxes = array(
		      'submitting_author' => array(
						   ...
						   'title' => __('Submitting Author','thesis'),
						   'function' => 'wbg_submitting_author_meta_box',
						   'noncename' => 'wormbook_submitting_author',
						   'fields' => array(
								     'wbg_submitting_author_first' => array(
													    'name'        => 'wbg_submitting_author_first',
													    'type'        => 'text',
													    'width'       => 'full',
													    'default'     => '',
													    'title'       => 'Custom Title Tag',
													    'description' => 'The first and last name and contact email of the submitting author.  You will be able to designate multiple corresponding authors later.',									  
													    'label'   => 'custom <code>&lt;title&gt;</code> tag',
													    'margin'  => true,
													    'upgrade' => false
													    ),
								     'wbg_submitting_author_last' => array(
													   'name'     => 'wbg_submitting_author_last',
													   'type'     => 'text',
													   'width'    => false,
													   'default'  => '',
													   'title'    => 'Last name',
													   'description' => 'The last name of the submitting author',
													   'label'       => '<code>&lt;meta&gt;</code> description',
													   'margin'  => true,
													   'upgrade' => 'meta'
													   ),
								     'wbg_submitting_author_email' => array(
													    'name'    => 'wbg_submitting_author_email',
													    'type'    => 'text',
													    'width'   => false,
													    'default' => '',
													    'title'   => 'Email',
													    'description' => 'The email of the submitting author',
													    'label' => '<code>&lt;meta&gt;</code> description',
													    'margin' => true,
													    'upgrade' => 'meta'
													    ),
